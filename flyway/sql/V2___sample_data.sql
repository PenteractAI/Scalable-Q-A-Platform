...
('Introduction to Data Science', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi consequat augue et lectus interdum rutrum. Integer bibendum dictum libero sed elementum. In laoreet semper volutpat. Maecenas sagittis turpis id neque posuere rhoncus. Aenean in dignissim mauris. Proin nec venenatis enim. Proin commodo tristique sapien vitae pulvinar. Vestibulum consequat dolor eu ex consequat pulvinar. Maecenas eget risus a sem interdum vestibulum in eu felis. Etiam eget pellentesque velit. Phasellus mattis elementum dapibus. Vestibulum nisi erat, luctus ac semper eget, auctor tristique leo. Maecenas vitae sem efficitur, ornare felis eget, consequat ipsum. Etiam tempor dolor urna, ac porta ex iaculis suscipit. Aenean mauris nulla, placerat et convallis id, sagittis iaculis diam.
Praesent in mauris pellentesque, volutpat felis a, commodo odio. Morbi tempus felis eu ex cursus aliquet. Praesent sed consequat eros. Phasellus commodo ante eu leo aliquam, vitae tristique nulla interdum. Donec non nisl felis. Phasellus dictum magna et sem vehicula, eu aliquam quam volutpat. Mauris imperdiet pretium magna eget convallis. Praesent sit amet dui at ipsum tristique finibus id ut lacus. Sed cursus nunc vel ante iaculis, vitae volutpat lectus lobortis. In hac habitasse platea dictumst. Ut blandit ex id lectus egestas vehicula. Curabitur sagittis rhoncus euismod. Nam dapibus molestie mi aliquet varius. Curabitur sapien purus, vestibulum a libero a, dictum molestie magna. Quisque gravida eros ac eros facilisis, ut gravida eros vulputate. Maecenas elementum gravida velit quis accumsan.'),
...
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'What exactly encompasses Data Science?', 'I''m new to the field and curious about the main components that define Data Science.'),
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Essential tools for a data scientist?', 'Looking for recommendations on tools and software that are crucial for data science work.'),
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'How do Data Science and Data Analytics differ?', 'Is there a clear distinction between these two fields, or do they overlap significantly?'),
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Recommended learning resources for Data Science?', 'What books, courses, or online resources are best for beginners?'),
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Exploring career paths in Data Science', 'What are the various career options in Data Science, and how do they differ?'),
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Importance of statistics in Data Science', 'How crucial is having a strong foundation in statistics for a data scientist?'),
...
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Understanding database normalization', 'Why is normalization important in database design, and what are its benefits?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Effective indexing strategies for databases', 'How can one design indexing strategies to improve query performance significantly?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Explaining ACID properties in databases', 'Can someone provide practical examples of ACID properties and their importance?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Scalability solutions for database systems', 'What are the best practices or technologies for scaling databases to accommodate growth?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Ensuring database security', 'What measures should be taken to secure database information effectively?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'The workings of distributed databases', 'How do distributed databases enhance performance and reliability, and when should they be used?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Benefits of data warehousing', 'What are the key advantages of implementing a data warehousing solution?'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Tips for optimizing database queries', 'Looking for advice on making database queries run faster and more efficiently.'),
(2, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Emerging trends in database technologies', 'What new technologies or approaches are shaping the future of database systems?');
...
(1, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi consequat augue et lectus interdum rutrum. Integer bibendum dictum libero sed elementum. In laoreet semper volutpat. Maecenas sagittis turpis id neque posuere rhoncus. Aenean in dignissim mauris. Proin nec venenatis enim. Proin commodo tristique sapien vitae pulvinar. Vestibulum consequat dolor eu ex consequat pulvinar. Maecenas eget risus a sem interdum vestibulum in eu felis. Etiam eget pellentesque velit. Phasellus mattis elementum dapibus. Vestibulum nisi erat, luctus ac semper eget, auctor tristique leo. Maecenas vitae sem efficitur, ornare felis eget, consequat ipsum. Etiam tempor dolor urna, ac porta ex iaculis suscipit. Aenean mauris nulla, placerat et convallis id, sagittis iaculis diam.
Donec lacinia magna in egestas egestas. Etiam condimentum odio libero, eget malesuada diam sagittis quis. Donec euismod turpis in ex fringilla imperdiet. Phasellus non felis urna. Nunc molestie nisi non lorem aliquam, nec lobortis ante egestas. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec imperdiet lacinia dui eu iaculis. Phasellus pulvinar erat diam, eu tincidunt nunc mattis sit amet. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
Praesent in mauris pellentesque, volutpat felis a, commodo odio. Morbi tempus felis eu ex cursus aliquet. Praesent sed consequat eros. Phasellus commodo ante eu leo aliquam, vitae tristique nulla interdum. Donec non nisl felis. Phasellus dictum magna et sem vehicula, eu aliquam quam volutpat. Mauris imperdiet pretium magna eget convallis. Praesent sit amet dui at ipsum tristique finibus id ut lacus. Sed cursus nunc vel ante iaculis, vitae volutpat lectus lobortis. In hac habitasse platea dictumst. Ut blandit ex id lectus egestas vehicula. Curabitur sagittis rhoncus euismod. Nam dapibus molestie mi aliquet varius. Curabitur sapien purus, vestibulum a libero a, dictum molestie magna. Quisque gravida eros ac eros facilisis, ut gravida eros vulputate. Maecenas elementum gravida velit quis accumsan.'),
...
(11, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'From my experience, NoSQL is a better choice when you need flexibility for your database schema. If your data model is evolving or you’re working with JSON documents, NoSQL databases like MongoDB allow for schema-less storage, which means you can add new data types without restructuring your entire database.'),
(11, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'NoSQL databases often provide more horizontal scalability than traditional SQL databases. This means that if your application expects a high level of traffic or data growth, you might find it easier to scale out with NoSQL. They’re built to distribute data across multiple servers from the get-go.'),
(11, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'It really depends on the specific requirements of your project. NoSQL databases can handle a wide variety of data types and structures, making them ideal for projects that involve dynamic, complex datasets which do not fit neatly into tables, like graphs or time-series data.'),
(11, '903e64c9-d1d8-4870-b12c-f56247290c6f', 'One of the main reasons to go for NoSQL is when you’re dealing with high-performance applications that require fast data access, irrespective of the data’s structure. NoSQL databases can provide faster responses because they allow you to work with data in a way that’s more natural to the programming language being used.');
